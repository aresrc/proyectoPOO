...
public class RegistrarMedico extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        S3.setText("DNI");
        add(S3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, -1, -1));

        S1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S1.setText("Nombre");
        add(S1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, -1, -1));

        S2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S2.setText("Sexo");
        add(S2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, -1, -1));

        S4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S4.setText("Edad");
        add(S4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));
        ...
        add(Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 220, 30));
        ...
        add(DNI, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 220, 30));
        ...
        add(Sexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 220, 30));
        ...
        add(Edad, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 220, 30));

        S10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S10.setText("Código");
        add(S10, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 50, -1, -1));

        S11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S11.setText("Grado de formación");
        add(S11, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, -1, -1));

        S12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        S12.setText("Años de experiencia");
        add(S12, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 140, -1, -1));
        ...
        add(Nombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, 220, 30));
        ...
        add(Sexo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 220, 30));
        ...
        add(Edad2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 220, 30));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 0, 30, 400));
